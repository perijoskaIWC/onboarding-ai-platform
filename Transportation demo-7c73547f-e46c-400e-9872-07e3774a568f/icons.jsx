// Lightweight icon set. 18px default, stroke 1.5.
...
const ICONS = {
  ...
  unlock: <><rect x="4" y="11" width="16" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 7-2"/></>,
  ...
  graduation: <><path d="m2 9 10-5 10 5-10 5z"/><path d="M6 11v5c0 1.5 3 3 6 3s6-1.5 6-3v-5"/></>,
  ...
  pin: <><path d="M12 17v5"/><path d="M9 12 5 8l3-3 12 12-3 3-4-4z"/></>,
  globe2: <><circle cx="12" cy="12" r="9"/><path d="M12 3c3 3 3 15 0 18M3 12h18"/></>,
};
